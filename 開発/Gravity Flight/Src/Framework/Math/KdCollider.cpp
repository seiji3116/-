...
//// add: 設定しているコライダーのタイプを書き換える
//void KdCollider::SetCollisionType(std::string_view name, KdCollider::Type type)
//{
//	auto targetCol = m_collisionShapes.find(name.data());
//
//	if (targetCol != m_collisionShapes.end());
//	{
//		targetCol->second->SetType(type);
//	}
//}
//
//// add: 設定しているコライダーのタイプに任意のタイプを追加する
//void KdCollider::AddCollisionType(std::string_view name, KdCollider::Type type)
//{
//	auto targetCol = m_collisionShapes.find(name.data());
//
//	if (targetCol != m_collisionShapes.end());
//	{
//		UINT temp = targetCol->second->GetType() | type;
//		targetCol->second->SetType(temp);
//	}
//}
